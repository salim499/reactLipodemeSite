    ...
    <div className="container">
      ...
      <ReactBootStrap.Card style={{ width: '1035px', }}>
       <ReactBootStrap.Card.Body>
          <ReactBootStrap.Card.Title><h3>Dr Roxana Aldea</h3></ReactBootStrap.Card.Title><br/>
          <ReactBootStrap.Card.Text>
           <h5 className="simple">Médecin anesthésiste-réanimateur  |  Clinique Turin, 75008 Paris  
           |  Tel : 06.25.84.13.11</h5>
  ...
  <ReactBootStrap.Carousel.Item>
    ...
    <ReactBootStrap.Carousel.Caption>
       ...
       <ReactBootStrap.Card.Body>
          ...
          <ReactBootStrap.Card.Text>
          <label>Vous prendrez un rendez-vous avec elle.</label><br/>
          ...
          <label>Notre clinique travail avec avec deux médecins Anesthésistes, Docteur Aldea et  
            <Link to="/Docteur_Caraco"> Docteur Caraco</Link></label>
          </ReactBootStrap.Card.Text>
       </ReactBootStrap.Card.Body>   
     </ReactBootStrap.Card>
     </div>

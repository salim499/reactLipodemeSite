  ...
  <ReactBootStrap.Carousel.Item>
    ...
    <ReactBootStrap.Carousel.Caption>
       ...
       <ReactBootStrap.Card.Title>C’est l’intervenant principal de votre opération</ReactBootStrap.Card.Title>
          <ReactBootStrap.Card.Text>
<label>Il pratique l’examen médical esthétique pré-opératoire dans l’Institut.</label><br></br>
<label>Le chirurgien esthétique vous expliquera l’opération en détails.</label><br></br>
<label>Il vous dira si elle peut être pratiquée sous anesthésie locale ou générale.</label><br></br>
<label>Le Dr Nicolas Zwillinger pratique lui-même tous ses actes chirurgicaux opératoires.</label><br></br>
<label>Il s’occupe aussi du suivi médical et chirurgical au cabinet.</label><br></br>
<label>Le Chirurgien est joignable pour toute question sur son téléphone ou par mail 24h/24, 7j/7.</label><br></br>
<label>Il s’assure de la bonne évolution post-opératoire.</label>
          </ReactBootStrap.Card.Text>
       </ReactBootStrap.Card.Body> 
     </ReactBootStrap.Card>
     </div>  
